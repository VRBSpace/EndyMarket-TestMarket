                    ...
                    <div class="container">
                        <div class="d-flex align-items-center">
                            <div class="topbar-left">
                                <a href="#" class="text-gray-110 font-size-13 hover-on-dark">Добре дошли в Valpers!</a>
                            </div>
                            ...
                            <div class="col-auto">
                                ...
                                <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between max-width-270 min-width-270">
                                    ...
                                    <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="../home/index.html" aria-label="Electro">
                                        ...
                                        <img src="<?= base_url('assets/img/logo_1.png') ?>" alt="">
                                    </a>
                                    <!-- End Logo -->
                            ...
                            <div class="col d-none d-xl-block">
                                <form class="js-focus-state">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control py-2 pl-5 font-size-15 border-right-0 height-40 border-width-2 rounded-left-pill border-primary" name="product_name" id="searchproduct-item" placeholder="Търси продукт" aria-label="Търси продукт" aria-describedby="searchProduct1" required>
                        ...
                        <div class="col-md-6 mb-4 mb-xl-0 col-xl-3">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="email" require class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="mb-6">
                                <a href="#" class="d-inline-block">
                                    <img src="<?= $_ENV['app.imagePortalDir'] . $logo ?? '' ?>" alt="">
                                </a>
                            </div>
                            <div class="mb-4">
                                ...
                                <form class="js-validate">
                                    ...
                                    <div id="login" data-target-group="idForm">
                                        ...
                                        <div class="text-center mb-4">
                                            <span class="small text-muted">Нямаш акаунт?</span>
                                    ...
                                    <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                                        ...
                                        <div class="form-group">
                                            <div class="js-form-message js-focus-state">
                                                <label class="sr-only" for="signupEmail"> Декларирам, че</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <input type="checkbox" class="form-control" name="agree" id="signupEmail" placeholder="Email" aria-label="Email" aria-describedby="signupEmailLabel" required
                                                           data-msg="Please check."
                                                           data-error-class="u-has-error"
                                                           data-success-class="u-has-success">
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-2">
                                            <button type="submit" class="btn btn-block btn-sm btn-primary transition-3d-hover">Изпрати заявката</button>
                                        </div>
