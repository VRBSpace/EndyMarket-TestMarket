...
// Един и същ markup като началната страница
...
<div id="js-products-grid" class="tab-pane fade pt-2 show active"  role="tabpanel" aria-labelledby="pills-one-example1-tab" data-target-group="groups">
    ...
    <ul class="row list-unstyled products-group no-gutters">
        <?php foreach ($products ?? [] as $product): ?>
            <li class="col-6 col-md-3 d-flex">
...
<?= view($views['shop-productsList']) ?>

<!-- Shop Pagination -->
<nav class="d-md-flex justify-content-between align-items-center border-top pt-3" aria-label="Page navigation example">
    <div class="text-center text-md-left mb-3 mb-md-0">Показани <strong><?= $countShowProducts ?></strong> | <strong><?= $countTotalProducts ?></strong> продукта общо</div>
