    ...
    <div class="container position-relative">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="mb-3">Политика за бисквитки</h2>
                <ul class="list-unstyled d-flex flex-wrap justify-content-center align-items-center mb-0">
                    ...
                    <li class="mx-2 my-1">
                        <p class="text-white text-decoration-none d-inline-flex align-items-center p-0 m-0">
                            <i class="fa fa-cookie-bite mr-2"></i><span>Политика за бисквитки</span>
                        </p>
                    </li>
                </ul>
            </div>
