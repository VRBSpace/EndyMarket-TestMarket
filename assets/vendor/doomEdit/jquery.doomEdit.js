...
( function ($) {
    $.fn.doomEdit = function (options) {
        ...
        this.config = {
            ...
            ajaxSubmit: true,
            submitBtn: '<button type="submit" class="save-btn border-0"><i class="btn-outline-primary p-1 fa fa-save"></i></button>',
            cancelBtn: '<button type="button" class="cancel-btn border-0"><i class="btn-outline-danger p-1 fa fa-reply-all"></i></button>',
            editField: '<input class="ml-1 w-75" name="{editFieldName}" type="text" autocomplete="off" style="outline: none"/>',
        ...
        if (options == 'destroy') {
            ...
            $(this).parent().children('#' + self.config.editForm.id + ',.' + self.config.doomEditJson).remove();
        }
    ...
    $.fn.showEditForm = function () {
        ...
        cancelButton.click(function () {
            editForm.remove();
            $('.' + self.config.doomEditJson).remove();
        ...
        editForm.submit(function () {
            ...
            if (self.config.ajaxSubmit) {
                $.ajax({
                    ...
                    dataType: editForm.attr('dataType'),
