    ...
    <div class="container position-relative">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="mb-3">Политика за защита на личните данни</h2>
                <ul class="list-unstyled d-flex flex-wrap justify-content-center align-items-center mb-0">
                    ...
                    <li class="mx-2 my-1">
                       <p href="<?= route_to('Pages-about') ?>" class="text-white text-decoration-none d-inline-flex align-items-center p-0 m-0">
                            <i class="fa fa-envelope mr-2"></i><span>Политика за защита на личните данни</span>
                        </p>
                    </li>
                </ul>
            </div>
...
<div id="content" class="site-content py-5" tabindex="-1">
    <div class="container">
        <div id="content" class="col-sm-12">
            <?= $settings_portal['privacyData'] ?? '' ?> <!-- in basecontroller  -->
        </div>
    </div><!-- .col-full -->
</div><!-- #content -->
