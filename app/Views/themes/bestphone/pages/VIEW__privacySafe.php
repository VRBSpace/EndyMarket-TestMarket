    ...
    <div class="container position-relative">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="mb-3">Начини за плащане и доставка</h2>
                <ul class="list-unstyled d-flex flex-wrap justify-content-center align-items-center mb-0">
                    ...
                    <li class="mx-2 my-1">
                        <p href="<?= route_to('Pages-about') ?>" class="text-white text-decoration-none d-inline-flex align-items-center p-0 m-0">
                            <i class="fa fa-envelope mr-2"></i><span>Начини за плащане и доставка</span>
                        </p>
                    </li>
                </ul>
            </div>
...
<div id="content" class="site-content py-5" tabindex="-1">
    <div class="container">
        <div id="content" class="col-sm-12">
            <?= $settings_portal['privacySafe'] ?? '' ?> <!-- in basecontroller  -->
        </div>
    </div><!-- .col-full -->
</div><!-- #content -->
